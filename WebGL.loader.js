function createUnityInstance(t, n, d) {
    ...
    var h, f, p, g, b, v, w, y, C, S = {
        Module: m, SetFullscreen: function () {
            ...
            var e = m._getMetricsInfo(), t = e + 4, n = t + 4, r = n + 8, o = r + 8, a = o + 4, i = a + 4, s = i + 8,
                d = s + 8, c = d + 4, l = c + 4, u = l + 4;
            return {
    ...
    m.SystemInfo = function () {
        ...
        for (var d = [["Windows (.*?)[;)]", "Windows"], ["Android ([0-9_.]+)", "Android"], ["iPhone OS ([0-9_.]+)", "iPhoneOS"], ["iPad.*? OS ([0-9_.]+)", "iPadOS"], ["FreeBSD( )", "FreeBSD"], ["OpenBSD( )", "OpenBSD"], ["Linux|X11()", "Linux"], ["Mac OS X ([0-9_\\.]+)", "MacOS"], ["bot|google|baidu|bing|msn|teoma|slurp|yandex", "Search Bot"]], c = 0; c < d.length; ++c) if (l = i(d[c][0], o, 1)) {
        ...
        var e = a.body ? a.body.getReader() : void 0, d = void 0 !== a.headers.get("Content-Length"),
            c = function (e, t) {
                if (!t) return 0;
            ...
            }(a, d), l = new Uint8Array(c), u = [], h = 0, f = 0;
    ...
    }, m.UnityCache = (h = {name: "UnityCache", version: 4}, f = {
        name: "RequestMetaDataStore",
        version: 1
    }, p = "RequestStore", g = "WebAssembly", b = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, v = null, E.getInstance = function () {
        return v = v || new E
        ...
        e.objectStoreNames.contains(f.name) || (t = e.createObjectStore(f.name, {keyPath: "url"}), ["accessedAt", "updatedAt"].forEach(function (e) {
            t.createIndex(e, e)
    ...
    }, E), m.cachedFetch = (w = m.UnityCache, y = m.fetchWithProgress, C = m.readBodyWithProgress, function (o, a) {
        var e, t, i = w.getInstance(), s = U("string" == typeof o ? o : o.url),
            d = {enabled: (e = s, (!(t = a) || !t.method || "GET" === t.method) && ((!t || -1 != ["must-revalidate", "immutable"].indexOf(t.control)) && !!e.match("^https?://")))};
        ...
        function c(n, r) {
            return fetch(n, r).then(function (e) {
                ...
                })) : (D("'" + s + "' request failed with status: " + e.status + " " + e.statusText), C(e, r.onProgress, r.enableStreamingDownload))
            })
        }
        ...
        return a && (d.control = a.control, d.companyName = a.companyName, d.productName = a.productName, d.productVersion = a.productVersion), d.revalidated = !1, d.metaData = {
            ...
            }), C(n, a.onProgress, a.enableStreamingDownload)) : (e = s, (t = window.location.href.match(/^[a-z]+:\/\/[^\/]+/)) && !e.lastIndexOf(t[0], 0) || !n.headers.get("Last-Modified") && !n.headers.get("ETag") ? (e = (a = a || {}).headers || {}, a.headers = e, n.headers.get("Last-Modified") ? (e["If-Modified-Since"] = n.headers.get("Last-Modified"), e["Cache-Control"] = "no-cache") : n.headers.get("ETag") && (e["If-None-Match"] = n.headers.get("ETag"), e["Cache-Control"] = "no-cache"), c(o, a)) : fetch(s, {method: "HEAD"}).then(function (t) {
            ...
            return D("Failed to load '" + d.metaData.url + "' from indexedDB cache due to the error: " + e), y(o, a)
        }) : y(o, a)
    });
    var k = {
        gzip: {
    ...
    function x() {
        var t, e, n, s, r, o = performance.now(), p = (new Promise(function (a, e) {
            ...
            a = (P(t = "dataUrl"), e = m.cacheControl(m[t]), n = m.companyName && m.productName ? m.cachedFetch : m.fetchWithProgress, s = m[t], r = /file:\/\//.exec(s) ? "same-origin" : void 0, n(m[t], {
                method: "GET",
    ...
    return new Promise(function (e, t) {
        ...
        m.SystemInfo.hasWebGL ? 1 == m.SystemInfo.hasWebGL ? (n = 'Your browser does not support graphics API "WebGL 2" which is required for this content.', "Safari" == m.SystemInfo.browser && parseInt(m.SystemInfo.browserVersion) < 15 && (m.SystemInfo.mobile || 1 < navigator.maxTouchPoints ? n += "\nUpgrade to iOS 15 or later." : n += "\nUpgrade to Safari 15 or later."), t(n)) : m.SystemInfo.hasWasm ? (m.startupErrorHandler = t, d(0), m.postRun.push(function () {
            d(1), delete m.startupErrorHandler, e(S), m.pageStartupTime = performance.now()
